...
const SignUp = () => {
  return (
    <div className="w-11/12 h-screen mx-auto py-8 bg-red-800 flex flex-col justify-center items-center">
   
     
        <h3 className=" text-center text-4xl font-bold text-[#ff5c15] my-10">
          Bill Buddy
        </h3>
...
<button className="btn bg-white text-black border-[#e5e5e5] w-full">
  ...
  Sign Up with Google
          ...
          <div className="">
            <img src="../../assets/bill_buddy_mascot-1.png" alt="" />
          </div>
        </div>
      </div>
